 ...
 */
public class KInflector {

    protected static final KInflector INSTANCE = new KInflector();

    public static final KInflector getInstance() {
        return INSTANCE;
    }
    ...
    protected KInflector( KInflector original ) {
    ...
    @Override
    public KInflector clone() {
        return new KInflector(this);
    }
    ...
    public String slug(String s) {
    	...
    	if (result.length() == 0 || result.equals("-")) return "";
    ...
    /**
     * Get the set of words that are not processed by the KInflector. The resulting map is directly modifiable.
     * 
